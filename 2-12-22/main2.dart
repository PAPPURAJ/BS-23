...
class _MyHomePageState extends State<MyHomePage> {
   ...
   List<String> name=["Rohim","karim","Jobbar","asad"];
   ...
   void _showToast(BuildContext context) {
    ...
    addList(){
      ...
      setState(() {
        name.insert(0, myController.value.text);
      });
    }
      ...
      body: Container(
        ...
        child: Column(
          children: [
            ...
            Row(children: [
              Flexible(child: TextField(controller: myController),flex: 4),
              Flexible(child: ElevatedButton(child: Text("Add"),onPressed: (){
                addList();
              },),flex: 1,)
            ],),
            Expanded(
              child: ListView.separated(
                  ...
                  itemBuilder: (context,index){
                    return Column(
                      children: [
                        Center(child: Text(name[index],style: TextStyle(fontSize: 22),)),
                      ],
                    );
                  },
